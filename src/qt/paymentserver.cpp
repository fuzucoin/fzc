...
const QString BITCOIN_IPC_PREFIX("Prosperity:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Prosperity: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Prosperity: click-to-pay handler");
    else
...
{
    // clicking on Prosperity: URLs creates FileOpen events on the Mac:
