...
static const int64_t MAX_MONEY = 29700000 * COIN;
...
public:
    ...
    {
        // Prosperity: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Prosperity: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Prosperity: two types of block: proof-of-work or proof-of-stake
    ...
    // Prosperity: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Prosperity: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Prosperity: block index flags
    enum  
    {
